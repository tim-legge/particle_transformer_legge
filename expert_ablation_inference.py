...
class Block(nn.Module):
    def __init__(self, embed_dim=128, num_heads=8, ffn_ratio=4,
                 ...
                 return_pre_softmax=False, ablated_experts=None):
        super().__init__()
        ...
        self.ablated_experts = ablated_experts if ablated_experts is not None else []
    ...
    def forward(self, x, x_cls=None, padding_mask=None, attn_mask=None):
        ...
        with torch.no_grad():
            router_logits = self.router(tokens) # shape (num_tokens, num_experts)
            ...
            for idx in self.ablated_experts:
...
if model == '10_pct':
    ...
    modelpath = 'models/jc_100_seed_1_net_epoch_state.pt'
